...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  ro: {
    ...
    'auth.subtitle': 'Te rugăm să te autentifici folosind credentialele tale',
  ...
  en: {
    ...
    'auth.subtitle': 'Please login using your account credentials in order to access the accont area',
